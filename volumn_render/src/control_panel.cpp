...
extern void gl_ortho_begin(unsigned size_x, unsigned size_y);
...
void drawHistogram(){
	...
	glVertex2i(HISTORGRAM_POSX + 256,HISTORGRAM_POSY);
	glVertex2i(HISTORGRAM_POSX + 256 ,HISTORGRAM_POSY + 255);
	glVertex2i(HISTORGRAM_POSX, HISTORGRAM_POSY + 255);
	glEnd();
	...
	for( int i = 0 ; i != 256 ; i++){
		if( i % 51  == 0 ){
			...
			glBegin( GL_LINES );
			glVertex2i( HISTORGRAM_POSX + i , HISTORGRAM_POSY - 5 );
			glVertex2i( HISTORGRAM_POSX + i , HISTORGRAM_POSY + 5 );
			glEnd();
		}
	}
	for( int i = 0 ; i != 256 ; i++){
		if( i % 51  == 0 ){
			string_render( itoa( i  + 1 , num , 10 ) , HISTORGRAM_POSX - 20 , HISTORGRAM_POSY + i );
			glColor3ub( 255 , 255 , 255 );
			glBegin( GL_LINES );
			glVertex2i( HISTORGRAM_POSX - 5 , HISTORGRAM_POSY + i );
			glVertex2i( HISTORGRAM_POSX + 5 , HISTORGRAM_POSY + i );
			glEnd();
		}
	}
	...
	if( b_log10 ){
		string_render( "count(log10)" , HISTORGRAM_POSX - 100, HISTORGRAM_POSY + 128 );
	}else{
		string_render( "count(org.)" , HISTORGRAM_POSX - 100, HISTORGRAM_POSY + 128 );
	}
...
void drawTransferFuctionView(){
	...
	glEnd();
	glDisable( GL_BLEND );
	string_render( "0.0" , TRANSFERVIEW_POSX - 20, TRANSFERVIEW_POSY + 0 );
	string_render( "0.5" , TRANSFERVIEW_POSX - 20, TRANSFERVIEW_POSY + 128 );
	string_render( "1.0" , TRANSFERVIEW_POSX - 20, TRANSFERVIEW_POSY + 256 );


	string_render( "opacity" , TRANSFERVIEW_POSX - 100, TRANSFERVIEW_POSY + 128 );
}
void drawColorTiles(){
